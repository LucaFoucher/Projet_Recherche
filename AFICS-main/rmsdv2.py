...
import sklearn_metrics
from sklearn_metrics import pairwise_distances
...
class Trajectory ():
    ...
    def getThresholdAtoms(self):
        ...
        for i, frame in enumerate(self.atoms):
            ...
            # on répère l'ion référence et on choisit le bon si y'en a plusieurs
            for atom in frame:
        ...
        # threshold est un tableau des coordonnées des atomes pour les frames avec le bon CN
    ...
    def getRDF(self):
        ...
        #print("distances",len(distances),len(distances[1]))
        #print("atomeB",len(atom_B_tol_num))
...
def dist_eq(c1, c2):
    return pairwise_distances(c1,c2)
